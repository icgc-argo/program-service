...
@NoArgsConstructor
@AllArgsConstructor
public class ProgramPrimarySite implements IdentifiableEntity<org.icgc.argo.program_service.model.join.ProgramPrimarySiteId> {

  @EmbeddedId
  private org.icgc.argo.program_service.model.join.ProgramPrimarySiteId id;

  @EqualsAndHashCode.Exclude
  @ToString.Exclude
  @MapsId(value = org.icgc.argo.program_service.model.join.ProgramPrimarySiteId.Fields.programId)
  ...
  @EqualsAndHashCode.Exclude
  @ToString.Exclude
  @MapsId(value = org.icgc.argo.program_service.model.join.ProgramPrimarySiteId.Fields.primarySiteId)
  ...
  public static Optional<ProgramPrimarySite> createProgramPrimarySite(@NonNull ProgramEntity p, @NonNull PrimarySiteEntity ps){
    ...
    val programPrimarySite = ProgramPrimarySite.builder()
        .id(org.icgc.argo.program_service.model.join.ProgramPrimarySiteId.builder()
